...
Все навыки находятся в каталоге `russian-editing-skills/` рядом с этим файлом. Каждый содержит SKILL.md с основными правилами и подробные справочники в `references/`.
...
Полное описание паспорта оформления и вертикального контроля: `references/review-methodology.md`
